...
class Message {
	...
	async send(content, opts = {}) {
		...
		const message = {
			...(type === 'text'
				? { text: config.LANG.toLowerCase() === 'en' ? content.toString() : await XSTRO.translate(cleanText(content.toString()), config.LANG.toLowerCase()) }
				: type === 'image'
				? {
