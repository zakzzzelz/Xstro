...
export async function getConfigValues() {
	...
	const { autoRead, autoStatusRead, cmdReact, cmdRead, mode, PREFIX, autolikestatus } = db_list;
	return { autoRead, autoStatusRead, cmdReact, cmdRead, mode, PREFIX, autolikestatus };
}
