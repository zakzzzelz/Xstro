...
export async function serialize(msg, conn) {
   ...
   if (msg.message) {
         ...
         if (quoted) {
            ...
            if (quoted['viewOnceMessageV2']) {
               ...
               msg.quoted = {
                  ...
                  sender: quotedSender,
                  message: quoted,
                  body: quoted[quotedType]?.text || quoted[quotedType]?.caption || quoted[quotedType]?.description || '',
               };
            }
      ...
      if (msg.message['ephemeralMessage']) {
         ...
         msg.body = msg.body || msg.message.ephemeralMessage.message[ephemeralType]?.text || msg.message.ephemeralMessage.message[ephemeralType]?.caption || msg.message.ephemeralMessage.message[ephemeralType]?.description || '';
         ...
         msg.body = msg.body || msg.message.conversation || msg.message[msg.type]?.text || msg.message[msg.type]?.caption || msg.message[msg.type]?.description || false;
      }
   }
